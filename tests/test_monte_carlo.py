...
def test_constant_lambda_integral_close_to_lambda_times_length():
    ...
    val = mc_integrate_lambda_t(lambda_fn=constant_lambda, t_start=0.0, t_end=4.0, n_samples=200, seed=0)
...
def test_linear_lambda_integral_close_to_analytic():
    ...
    val = mc_integrate_lambda_t(lambda_fn=linear_lambda, t_start=0.0, t_end=5.0, n_samples=500, seed=1)
